...
<div class="tabcordion tabcordion-lego">
	<ul class="tabcordion-tabs">
		<li class="tabcordion-tab js-collapsible-tab is-active">
			<a class="js-collapsible" href="#ex8-tab1{{ version[0] | handleize }}">Rabbit hole</a>
		</li>
		<li class="tabcordion-tab js-collapsible-tab">
			<a class="js-collapsible" href="#ex8-tab2{{ version[0] | handleize }}">Flamingo</a>
		</li>
		<li class="tabcordion-tab js-collapsible-tab">
			<a class="js-collapsible" href="#ex8-tab3{{ version[0] | handleize }}">Caterpillar</a>
		</li>
	</ul>
