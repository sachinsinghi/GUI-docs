...
<div class="tabcordion tabcordion-lego">
	<ul class="tabcordion-tabs">
		<li class="tabcordion-tab is-active">
			<a class="js-collapsible" href="#ex8-tab1">Rabbit hole</a>
		</li>
		<li class="tabcordion-tab">
			<a class="js-collapsible" href="#ex8-tab2">Flamingo</a>
		</li>
		<li class="tabcordion-tab">
			<a class="js-collapsible" href="#ex8-tab3">Caterpillar</a>
		</li>
	</ul>

	<div class="tabcordion-body-header is-active">
		<a href="#ex8-tab1" class="tabcordion-body-headline js-collapsible">Down that rabbit hole</a>
	</div>
	<div id="ex8-tab1" class="collapsible-body is-open" aria-hidden="false" tabindex="-1">
	...
	<div class="tabcordion-body-header">
		<a href="#ex8-tab2" class="tabcordion-body-headline js-collapsible">Managing a flamingo</a>
	</div>
	<div id="ex8-tab2" class="collapsible-body" aria-hidden="true" tabindex="-1">
		<div class="tabcordion-body">
	...
	<div class="tabcordion-body-header">
		<a href="#ex8-tab3" class="tabcordion-body-headline js-collapsible">The languid, sleepy Caterpillar</a>
	</div>
	<div id="ex8-tab3" class="collapsible-body" aria-hidden="true" tabindex="-1">
		<div class="tabcordion-body">
