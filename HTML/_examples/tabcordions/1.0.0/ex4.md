...
<div class="tabcordion tabcordion-lego tabcordion-tabs">
	<ul class="tabcordion-tabs">
		<li class="tabcordion-tab is-active">
			<a class="js-collapsible" href="#ex3-tab1">Rabbit hole</a>
		</li>
		<li class="tabcordion-tab">
			<a class="js-collapsible" href="#ex3-tab2">Flamingo</a>
		</li>
		<li class="tabcordion-tab">
			<a class="js-collapsible" href="#ex3-tab3">Caterpillar</a>
		</li>
	</ul>

	<div id="ex3-tab1" class="collapsible-body is-open" aria-hidden="false" tabindex="-1">
	...
	<div id="ex3-tab2" class="collapsible-body" aria-hidden="true" tabindex="-1">
		<div class="tabcordion-body">
	...
	<div id="ex3-tab3" class="collapsible-body" aria-hidden="true" tabindex="-1">
		<div class="tabcordion-body">
