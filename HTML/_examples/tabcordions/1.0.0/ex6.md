...
<div class="tabcordion tabcordion-accordion">
	<div class="tabcordion-body-header is-active">
		<a href="#ex5-tab1" class="tabcordion-body-headline js-collapsible">Down that rabbit hole</a>
	</div>
	<div id="ex5-tab1" class="collapsible-body is-open" aria-hidden="false" tabindex="-1">
	...
	<div class="tabcordion-body-header">
		<a href="#ex5-tab2" class="tabcordion-body-headline js-collapsible">Managing a flamingo</a>
	</div>
	<div id="ex5-tab2" class="collapsible-body" aria-hidden="true" tabindex="-1">
		<div class="tabcordion-body">
	...
	<div class="tabcordion-body-header">
		<a href="#ex5-tab3" class="tabcordion-body-headline js-collapsible">The languid, sleepy Caterpillar</a>
	</div>
	<div id="ex5-tab3" class="collapsible-body" aria-hidden="true" tabindex="-1">
		<div class="tabcordion-body">
