...
<div class="tabcordion tabcordion-lego tabcordion-tabs">
	<ul class="tabcordion-tabs tabcordion-tabs-justified">
		<li class="tabcordion-tab js-collapsible-tab is-active">
			<a class="js-collapsible" href="#ex4-tab1{{ version[0] | handleize }}">
				Rabbit hole
		...
		<li class="tabcordion-tab js-collapsible-tab">
			<a class="js-collapsible" href="#ex4-tab2{{ version[0] | handleize }}">
				Flamingo
		...
		<li class="tabcordion-tab js-collapsible-tab">
			<a class="js-collapsible" href="#ex4-tab3{{ version[0] | handleize }}">
				Caterpillar
