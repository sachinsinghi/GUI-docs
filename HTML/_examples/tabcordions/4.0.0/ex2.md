...
<div class="tabcordion tabcordion-tabs">
	<ul class="tabcordion-tabs">
		<li class="tabcordion-tab js-collapsible-tab is-active">
			<a class="js-collapsible" href="#ex1-tab1{{ version[0] | handleize }}">
				Rabbit hole
		...
		<li class="tabcordion-tab js-collapsible-tab">
			<a class="js-collapsible" href="#ex1-tab2{{ version[0] | handleize }}">
				Flamingo
		...
		<li class="tabcordion-tab js-collapsible-tab">
			<a class="js-collapsible" href="#ex1-tab3{{ version[0] | handleize }}">
				Caterpillar
