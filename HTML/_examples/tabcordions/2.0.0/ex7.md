...
<div class="tabcordion tabcordion-lego tabcordion-accordion">
	<div class="tabcordion-body-header js-collapsible-tab is-active">
		<a href="#ex6-tab1{{ version[0] | handleize }}" class="tabcordion-body-headline js-collapsible">Down that rabbit hole</a>
	</div>
	<div id="ex6-tab1{{ version[0] | handleize }}" class="collapsible-body is-open" aria-hidden="false" tabindex="-1">
	...
	<div class="tabcordion-body-header js-collapsible-tab">
		<a href="#ex6-tab2{{ version[0] | handleize }}" class="tabcordion-body-headline js-collapsible">Managing a flamingo</a>
	</div>
	<div id="ex6-tab2{{ version[0] | handleize }}" class="collapsible-body" aria-hidden="true" tabindex="-1">
		<div class="tabcordion-body">
	...
	<div class="tabcordion-body-header js-collapsible-tab">
		<a href="#ex6-tab3{{ version[0] | handleize }}" class="tabcordion-body-headline js-collapsible">The languid, sleepy Caterpillar</a>
	</div>
	<div id="ex6-tab3{{ version[0] | handleize }}" class="collapsible-body" aria-hidden="true" tabindex="-1">
		<div class="tabcordion-body">
