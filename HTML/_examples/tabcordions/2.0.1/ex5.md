...
<div class="tabcordion tabcordion-lego tabcordion-tabs">
	<ul class="tabcordion-tabs tabcordion-tabs-justified">
		<li class="tabcordion-tab js-collapsible-tab is-active">
			<a class="js-collapsible" href="#ex4-tab1{{ version[0] | handleize }}">Rabbit hole</a>
		</li>
		<li class="tabcordion-tab js-collapsible-tab">
			<a class="js-collapsible" href="#ex4-tab2{{ version[0] | handleize }}">Flamingo</a>
		</li>
		<li class="tabcordion-tab js-collapsible-tab">
			<a class="js-collapsible" href="#ex4-tab3{{ version[0] | handleize }}">Caterpillar</a>
		</li>
	</ul>

	<div id="ex4-tab1{{ version[0] | handleize }}" class="collapsible-body is-open" aria-hidden="false" tabindex="-1">
	...
	<div id="ex4-tab2{{ version[0] | handleize }}" class="collapsible-body" aria-hidden="true" tabindex="-1">
		<div class="tabcordion-body">
	...
	<div id="ex4-tab3{{ version[0] | handleize }}" class="collapsible-body" aria-hidden="true" tabindex="-1">
		<div class="tabcordion-body">
